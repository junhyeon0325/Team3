			...
			<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
				<div class="navbar-nav mx-auto">
					...
					<div class="nav-item dropdown">
						<a href="sales.do?maincategory=할인" class="nav-link dropdown-toggle"
							data-bs-toggle="dropdown">이벤트</a>
						<div class="dropdown-menu m-0 bg-secondary rounded-0">
							<a href="cart.html" class="dropdown-item">오늘의 이벤트</a> <a
								href="chackout.html" class="dropdown-item">임박 상품 특가</a> 
						</div>
					</div>
...
<!-- Modal Search End --> <!-- menu.jsp연결, menu에 검색기능도 menu.jsp에 넣음 -->
    	<!-- menu 끝 -->
...
<a href="#"
	...
	class="fa fa-arrow-up"></i></a> <!-- footer.jsp연결 -->
        <!-- footer 끝 -->   
